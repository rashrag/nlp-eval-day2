...
if __name__ == "__main__":
    ...
    ner = NerClient("1PI11CS188", "g11")
    #ret = ner.get_brand_product_bigrams_dict()
    fn = ["1PI11CS138_Rashmi_Scenario1.txt","1PI11CS138_Rashmi_Scenario2.txt","1PI11CS138_Rashmi_Scenario5.txt","1PI11CS138_Rashmi_Scenario7.txt"]
    for i in fn :
        ret = ner.upload(i)
        print ret
